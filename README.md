...
- **[fabbo-ai/fabbo-ai-generator](https://github.com/fabbo-ai/fabbo-ai-generator)** - Generate AI videos and images on [fabbo.ai](https://fabbo.ai) by driving a real Playwright browser session. Supports text-to-video, image-to-video, text-to-image, reference-to-video, and image editing modes across Veo, Sora, Kling, Wan, Luma, Runway, Midjourney, and Nano Banana.
