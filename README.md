...
- **[vibecure/vibecure](https://github.com/vibecure/vibecure)** - Scans Node.js/Express backends for billing attacks and paid endpoint abuse (EDoS) — detects missing rate limits, uncapped AI costs, SMS toll fraud, credential leaks across 22+ providers (Twilio, SendGrid, OpenAI, etc.)
